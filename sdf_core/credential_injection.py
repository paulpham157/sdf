    ...
    *,
    ...
    for agent in agents:
        if agent not in plans:
            plans[agent] = resolve_credential_plan(agent, environ, read_connection=read_connection)
    if not plans:
...
def create_credentialed_transport(
    ...
    **transport_kwargs: Any,
    ...
    injection = prepare_credential_injection(agents, environ, read_connection=read_connection, base_envs=envs)
